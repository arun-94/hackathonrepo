...
public class ChatFragment extends Fragment
{
    ...
    public boolean checkLocation()
    {
        ...
        if (gpsTracker.canGetLocation())
        {
            ...
            {
                chatArrayAdapter.add(new ChatMessage(true, "Couldn't find your location. Check your connection!"));
            }
            else
            {
                chatArrayAdapter.add(new ChatMessage(true, "I've just got your location!"));
            }
            return true;
        } else
        {
